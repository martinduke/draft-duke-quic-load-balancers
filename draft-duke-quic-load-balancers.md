...
The block-cipher-encrypted CID algorithm provides true cryptographic protection and the opportunity for a load balancer to detect and drop packets carrying invalid Connection ID.
...
struct {
   ...
   opaque per_server_bytes[sizeof(BlockCipherCIDPlaintext) - NUM_SERVER_ID_BYTES - NUM_ZERO_BYTES];
